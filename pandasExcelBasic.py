...
import pandas as pd
import numpy as np
ddf=pd.read_excel(open('pandas.xlsx','rb'))
"""
...
col3=np.array(col3)
"""
#reading content attribute wise method2 using loc/iloc function(adv:row and colm both can select)
#col12=ddf.iloc[row,colmn]
col12=ddf.iloc[0:5,0:2]
col3=ddf.iloc[0:5,2]
col12=np.array(col12)
col3=np.array(col3)
